...
mod tests {
    ...
    fn warm_up_turn_completes_without_network() {
        // The agent-turn future is large in debug builds. Give this fixture the
        // same practical stack headroom as the benchmark binary's main thread
        // instead of relying on libtest's smaller worker-thread default.
