...
use crate::openhuman::web3::wallet::primitives::eip712::u256_from_decimal;
...
/// # }
/// # Ok::<(), crate::openhuman::web3::wallet::primitives::abi::Error>(())
/// ```
pub fn encode_erc20_transfer(to: &str, amount: &str) -> Result<String> {
    let recipient = crate::openhuman::web3::wallet::primitives::address::evm::validate(to)
        .map_err(|e| Error::InvalidRecipient {
            reason: e.to_string(),
        })?;
