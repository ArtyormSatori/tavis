...
//! [`crate::openhuman::web3::wallet::primitives::address::btc::validate_sender`] — the only script type this crate's
...
//! [`crate::openhuman::web3::wallet::primitives::address::btc::encode_p2wpkh`], which also decodes it, and the
...
use crate::openhuman::web3::wallet::primitives::address::btc::encode_p2wpkh;
