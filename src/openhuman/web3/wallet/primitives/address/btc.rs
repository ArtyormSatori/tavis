...
//! [`crate::openhuman::web3::wallet::primitives::key`], which deliberately still delegates. The distinction is
...
use crate::openhuman::web3::wallet::primitives::{Error, Result};
...
///
/// The counterpart to parsing: [`crate::openhuman::web3::wallet::primitives::key`] derives a public key and needs
