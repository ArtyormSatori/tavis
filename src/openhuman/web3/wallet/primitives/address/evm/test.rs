...
use super::validate;
use crate::openhuman::web3::wallet::primitives::{Chain, Error};
...
mod checksum {
    ...
    use crate::openhuman::web3::wallet::primitives::address::evm::{
        is_checksum_valid, to_checksummed,
    };
    ...
    fn reports_an_all_lowercase_address_as_unchecksummed() {
        ...
        let lower = "0x52908400098527886e0f7030069857d2e4169ee7";
        assert!(crate::openhuman::web3::wallet::primitives::address::evm::validate(lower).is_ok());
