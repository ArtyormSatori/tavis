...
//! `tinyagents::harness::session_store::run_ledger` and projects them into a [`CommandCenterView`]
...
mod tests {
    ...
    fn run_with(id: &str, status: AgentRunStatus, updated_secs: i64) -> AgentRun {
        AgentRun {
            id: id.to_string(),
            kind: tinyagents::harness::session_store::run_ledger::AgentRunKind::Subagent,
            parent_run_id: None,
