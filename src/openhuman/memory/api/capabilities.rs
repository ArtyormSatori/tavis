...
//! error. [`crate::openhuman::memory::api::error::MemoryError::Unsupported`] exists for the one case the
...
//!
//! Adding a family is a [`crate::openhuman::memory::api::CONTRACT_VERSION`] **minor** bump and should
...
impl Capability {
    ...
    /// driver and requires a [`crate::openhuman::memory::api::CONTRACT_VERSION`] major bump.
...
impl Capabilities {
    ...
    /// [`Self::mandatory`] via its [`MemoryProvider::capabilities`](crate::openhuman::memory::api::provider::MemoryProvider::capabilities)
