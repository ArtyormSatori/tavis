...
//!
//! A driver advertising [`Capability::Retrieval`](crate::openhuman::memory::api::capabilities::Capability::Retrieval)
...
pub trait MemoryRetrieval: Send + Sync {
    ...
    /// family's returns the raw [`Chunk`](crate::openhuman::memory::api::chunks::Chunk)s
    ...
    /// [`NamespaceMemoryHit`](crate::openhuman::memory::api::types::NamespaceMemoryHit),
