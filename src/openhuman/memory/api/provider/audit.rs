...
//! at bind time next to [`crate::openhuman::memory::api::capabilities::Capabilities::validate`], and in
...
use crate::openhuman::memory::api::provider::driver::MemoryProvider;
...
impl From<CapabilityAudit> for MemoryError {
    ...
    /// [`crate::openhuman::memory::api::capabilities::MissingMandatoryCapabilities`].
