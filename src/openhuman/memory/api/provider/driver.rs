...
//! [`crate::openhuman::memory::api::health`].
//!
...
//!   [`crate::openhuman::memory::api::provider::audit_provider`] compares [`MemoryProvider::capabilities`]
...
pub trait MemoryProvider: MemoryCore + MemoryRecall + MemoryPortability + 'static {
    ...
    /// accessor. [`crate::openhuman::memory::api::provider::audit_provider`] checks exactly that.
    ...
    /// agree; [`crate::openhuman::memory::api::provider::audit_provider`] is where they are compared.
    ///
