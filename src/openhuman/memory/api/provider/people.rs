...
//!
//! A driver advertising [`Capability::People`](crate::openhuman::memory::api::capabilities::Capability::People)
...
//! advertise it.
//!
//! [`MemoryEntities`]: crate::openhuman::memory::api::provider::MemoryEntities
//!
...
/// that does not advertise [`Capability::People`](crate::openhuman::memory::api::capabilities::Capability::People)
