...
//! [`crate::openhuman::memory::api::provider::MemoryCore`], [`crate::openhuman::memory::api::provider::MemoryRecall`], and
//! [`crate::openhuman::memory::api::provider::MemoryPortability`] could not be implemented without a
...
//! [`crate::openhuman::memory::api::error::MemoryError::Unsupported`] would contradict advertising
//! [`crate::openhuman::memory::api::capabilities::Capability::Core`], and one that returned a hard
...
//! [`crate::openhuman::memory::api::error::MemoryError::Unsupported`] naming its family, but the
//! `as_*` accessors return `None` and
//! [`crate::openhuman::memory::api::provider::MemoryProvider::capabilities`] lists only the mandatory
//! three. So:
//!
...
//!
//! [`crate::openhuman::memory::api::provider::audit_provider`] confirms the two views agree.
