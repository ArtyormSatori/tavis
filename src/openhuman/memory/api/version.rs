...
//! [`crate::openhuman::memory::api::CONTRACT_VERSION`] and [`crate::openhuman::memory::api::is_compatible`].
//!
//! ## The rule
//!
...
//!   A new [`crate::openhuman::memory::api::capabilities::Capability`] family is the canonical case: an
...
//!   advertising an existing family (say [`crate::openhuman::memory::api::capabilities::Capability::Core`])
