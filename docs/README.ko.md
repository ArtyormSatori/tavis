...
- **[잠재의식(subconscious)](https://tinyhumans.gitbook.io/openhuman/features/mascot#it-thinks-in-the-background-the-subconscious)**: 당신의 세계의 변화를 비교 분석하고, 목표를 진전시키고, 아침 브리핑을 작성하는 백그라운드 루프입니다. 타이핑을 멈춘 후에도 생각은 계속됩니다.
...
- **[미팅 에이전트](https://tinyhumans.gitbook.io/openhuman/features/mascot#it-joins-your-meetings-as-a-real-participant)**: 얼굴과 목소리를 가지고 **Meet, Zoom, Teams, Webex**에 참여합니다. 캘린더에서 자동으로 참여하고, 실시간 자막을 스트리밍하며, 이름이 불리면 대답하고, 요약과 액션 아이템을 정리합니다.
