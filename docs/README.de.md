...
- **[Ein Unterbewusstsein](https://tinyhumans.gitbook.io/openhuman/features/mascot#it-thinks-in-the-background-the-subconscious)**: eine Hintergrundschleife, die Veränderungen in deiner Welt erkennt, deine Ziele vorantreibt und dein Morgen-Briefing schreibt. Das Denken geht weiter, auch wenn du längst nicht mehr tippst.
...
- **[Meeting-Agenten](https://tinyhumans.gitbook.io/openhuman/features/mascot#it-joins-your-meetings-as-a-real-participant)**: nimmt an **Meet, Zoom, Teams und Webex** teil, mit Gesicht und Stimme. Tritt automatisch aus deinem Kalender bei, streamt ein Live-Transkript, antwortet auf seinen Namen und legt Zusammenfassung + Action Items ab.
