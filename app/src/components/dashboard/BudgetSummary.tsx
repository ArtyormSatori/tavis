  ...
  return (
    <section
      ...
      <div
        ...
        className="md:col-span-2 rounded-2xl border border-line bg-gradient-to-br from-primary-50 to-white dark:from-neutral-900 dark:to-neutral-950 p-5 flex flex-col gap-3 shadow-soft">
