...
describe('FlowRunInspectorDrawer', () => {
  ...
  it('renders the run status pill and step list once data resolves', () => {
    ...
    expect(screen.getByTestId('flow-run-status-pill')).toHaveClass('bg-primary-50');
    expect(screen.getByTestId('flow-run-status-dot')).toHaveClass('bg-primary-500', 'animate-pulse');
