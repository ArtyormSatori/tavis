  ...
  return (
    <span
      ...
      className={iconClasses(
        'flex h-8 w-8 items-center justify-center rounded-xl shadow-sm ring-1 ring-surface-overlay/5',
        bgClassName,
        className
      )}>
  ...
  return {
    ...
    yuanbao: (
      <span
        ...
        className="flex h-8 w-8 items-center justify-center rounded-xl shadow-sm ring-1 ring-surface-overlay/5 bg-surface">
