...
const messages: TranslationMap = {
  ...
  'conversations.composer.goal.title': 'Tujuan utas',
  'conversations.composer.goal.set': 'Tetapkan tujuan',
  'conversations.composer.goal.description': 'Beri utas ini sesuatu untuk dicapai. Tujuannya melekat pada utas.',
  'conversations.composer.goal.placeholder': 'Apa yang harus dicapai utas ini?',
