...
const messages: TranslationMap = {
  ...
  'conversations.composer.goal.title': 'Obiettivo della conversazione',
  'conversations.composer.goal.set': 'Imposta un obiettivo',
  'conversations.composer.goal.description': 'Dai a questa conversazione un obiettivo da raggiungere. Resta legato alla conversazione.',
  'conversations.composer.goal.placeholder': 'Che cosa deve raggiungere questa conversazione?',
