...
const messages: TranslationMap = {
  ...
  'welcome.gatewaySessionErrorFallback': 'अभी साइन-इन पूरा नहीं किया जा सका। सत्र स्टोर ने समय पर जवाब नहीं दिया (दोबारा प्रयास करने के बाद भी)। कृपया OpenHuman को पुनः आरंभ करें और फिर से प्रयास करें।',
