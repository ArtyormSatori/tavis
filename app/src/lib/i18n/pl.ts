...
const messages: TranslationMap = {
  ...
  'conversations.composer.goal.title': 'Cel wątku',
  'conversations.composer.goal.set': 'Ustaw cel',
  'conversations.composer.goal.description': 'Nadaj temu wątkowi cel do osiągnięcia. Zostaje przypisany do wątku.',
  'conversations.composer.goal.placeholder': 'Co ten wątek ma osiągnąć?',
