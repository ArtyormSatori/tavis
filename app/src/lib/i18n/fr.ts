...
const messages: TranslationMap = {
  ...
  'conversations.composer.goal.title': 'Objectif du fil',
  'conversations.composer.goal.set': 'Définir un objectif',
  'conversations.composer.goal.description': 'Donnez un objectif à ce fil. Il reste associé au fil.',
  'conversations.composer.goal.placeholder': 'Que doit accomplir ce fil ?',
