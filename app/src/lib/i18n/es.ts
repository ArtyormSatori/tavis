...
const messages: TranslationMap = {
  ...
  'conversations.composer.goal.title': 'Objetivo del hilo',
  'conversations.composer.goal.set': 'Definir objetivo',
  'conversations.composer.goal.description': 'Dale a este hilo algo que lograr. El objetivo se queda con el hilo.',
  'conversations.composer.goal.placeholder': '¿Qué debería lograr este hilo?',
