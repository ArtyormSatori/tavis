...
const messages: TranslationMap = {
  ...
  'conversations.composer.goal.title': 'Ziel des Threads',
  'conversations.composer.goal.set': 'Ziel festlegen',
  'conversations.composer.goal.description': 'Geben Sie diesem Thread ein Ziel. Es bleibt beim Thread.',
  'conversations.composer.goal.placeholder': 'Was soll dieser Thread erreichen?',
