...
const messages: TranslationMap = {
  ...
  'welcome.gatewaySessionErrorFallback': 'এই মুহূর্তে সাইন-ইন সম্পূর্ণ করা যায়নি। সেশন স্টোর সময়মতো সাড়া দেয়নি (বারবার চেষ্টা করেও)। অনুগ্রহ করে OpenHuman পুনরায় চালু করুন এবং আবার চেষ্টা করুন।',
