...
const messages: TranslationMap = {
  ...
  'conversations.composer.goal.title': 'থ্রেডের লক্ষ্য',
  'conversations.composer.goal.set': 'লক্ষ্য নির্ধারণ',
  'conversations.composer.goal.description': 'এই থ্রেডকে কাজ করার মতো একটি লক্ষ্য দিন। এটি থ্রেডের সঙ্গেই থাকে।',
  'conversations.composer.goal.placeholder': 'এই থ্রেড কী অর্জন করবে?',
