...
const messages: TranslationMap = {
  ...
  'conversations.composer.goal.title': '会话目标',
  'conversations.composer.goal.set': '设置目标',
  'conversations.composer.goal.description': '给这个会话一个要达成的目标，它会一直跟随该会话。',
  'conversations.composer.goal.placeholder': '这个会话要达成什么？',
