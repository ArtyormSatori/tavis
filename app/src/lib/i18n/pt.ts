...
const messages: TranslationMap = {
  ...
  'conversations.composer.goal.title': 'Objetivo da conversa',
  'conversations.composer.goal.set': 'Definir objetivo',
  'conversations.composer.goal.description': 'Dê a esta conversa algo a alcançar. O objetivo fica com a conversa.',
  'conversations.composer.goal.placeholder': 'O que esta conversa deve alcançar?',
