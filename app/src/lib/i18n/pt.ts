...
const messages: TranslationMap = {
  ...
  'settings.gateway.activating': 'A ligar…',
  'settings.gateway.activatingStep': 'A ligar: {step}',
  'settings.gateway.connected': 'Ligado em {endpoint}',
  'settings.gateway.failed': 'Não foi possível ligar: {reason}',
  'settings.gateway.nameLabel': 'Nome',
  'settings.gateway.namePlaceholder': 'Servidor de compilação',
  'settings.gateway.whereLegend': 'Onde deve correr?',
  ...
  'settings.gateway.kind.docker': 'Num contentor aqui',
  'settings.gateway.kind.ssh': 'Noutra máquina',
  'settings.gateway.kind.ssh+docker': 'Num contentor noutra máquina',
  'settings.gateway.kind.local-process': 'Neste computador',
  'settings.gateway.idRequired': 'Dá um nome a este local.',
  'settings.gateway.idReserved': 'Esse nome está reservado para o núcleo da própria aplicação.',
  'settings.gateway.destinationRequired': 'Indica a máquina a que te queres ligar.',
  'settings.gateway.imageRequired': 'Indica a imagem de contentor a executar.',
  'settings.gateway.binaryRequired': 'Indica o caminho para openhuman-core nessa máquina.',
  'settings.gateway.portInvalid': 'A porta SSH tem de ser um número.',
