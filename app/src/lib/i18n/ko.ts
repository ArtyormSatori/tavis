...
const messages: TranslationMap = {
  ...
  'conversations.composer.goal.title': '스레드 목표',
  'conversations.composer.goal.set': '목표 설정',
  'conversations.composer.goal.description': '이 스레드가 이룰 목표를 정하세요. 목표는 스레드에 남습니다.',
  'conversations.composer.goal.placeholder': '이 스레드로 무엇을 이루고 싶나요?',
