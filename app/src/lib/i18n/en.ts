...
const en: TranslationMap = {
  ...
  'conversations.composer.goal.title': 'Thread goal',
  'conversations.composer.goal.set': 'Set goal',
  'conversations.composer.goal.description': 'Give this thread something to work towards. It stays with the thread.',
  'conversations.composer.goal.placeholder': 'What should this thread accomplish?',
