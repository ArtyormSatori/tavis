...
const messages: TranslationMap = {
  ...
  'conversations.composer.goal.title': 'هدف المحادثة',
  'conversations.composer.goal.set': 'تحديد هدف',
  'conversations.composer.goal.description': 'امنح هذه المحادثة شيئًا تعمل من أجله. يبقى الهدف مرتبطًا بها.',
  'conversations.composer.goal.placeholder': 'ما الذي يجب أن تحققه هذه المحادثة؟',
