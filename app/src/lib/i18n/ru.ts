...
const messages: TranslationMap = {
  ...
  'welcome.gatewaySessionErrorFallback': 'Не удалось завершить вход в систему. Хранилище сеанса не ответило вовремя (даже после повторной попытки). Перезапустите OpenHuman и попробуйте снова.',
