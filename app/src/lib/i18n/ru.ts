...
const messages: TranslationMap = {
  ...
  'memorySources.codingSessions.stillRunningMessage':
    'На данный момент импортировано сессий: {processed}. Импорт не завершился в отведённое время, но продолжает выполняться в фоновом режиме; загляните через минуту, а не запускайте его заново.',
