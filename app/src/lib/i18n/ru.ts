...
const messages: TranslationMap = {
  ...
  'conversations.composer.goal.title': 'Цель обсуждения',
  'conversations.composer.goal.set': 'Задать цель',
  'conversations.composer.goal.description': 'Задайте этому обсуждению цель. Она сохраняется вместе с ним.',
  'conversations.composer.goal.placeholder': 'Чего должно достичь это обсуждение?',
