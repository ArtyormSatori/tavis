...
const messages: TranslationMap = {
  ...
  'settings.ai.providers.notConnected': 'Не подключено',
  ...
  'settings.ai.providers.addProviderPlaceholder': 'Выберите провайдера…',
  ...
  'settings.ai.providers.groupOther': 'Другое',
