...
async fn json_rpc_run_ledger_lifecycle() {
    ...
    tinyagents::harness::session_store::run_ledger::upsert_agent_run(
        &config.workspace_dir,
        tinyagents::harness::session_store::run_ledger::AgentRunUpsert {
            id: "sub-run-1".to_string(),
            kind: tinyagents::harness::session_store::run_ledger::AgentRunKind::WorkerThread,
            parent_run_id: Some("req-run-1".to_string()),
            parent_thread_id: Some("thread-run-1".to_string()),
            agent_id: Some("researcher".to_string()),
            status: tinyagents::harness::session_store::run_ledger::AgentRunStatus::AwaitingUser,
    ...
    tinyagents::harness::session_store::run_ledger::append_run_event(
        &config.workspace_dir,
        tinyagents::harness::session_store::run_ledger::RunEventAppend {
...
async fn json_rpc_workflow_run_definitions_and_runs_roundtrip() {
    ...
    tinyagents::harness::session_store::run_ledger::upsert_workflow_run(
        &config.workspace_dir,
        tinyagents::harness::session_store::run_ledger::WorkflowRunUpsert {
            ...
            status: tinyagents::harness::session_store::run_ledger::WorkflowRunStatus::Running,
            summary: None,
            started_at: None,
            completed_at: None,
        },
...
async fn json_rpc_agent_team_coordination_roundtrip() {
    ...
    let task_a = tinyagents::harness::session_store::run_ledger::get_agent_team_task(
        &config.workspace_dir,
        &task_a_id,
    )
    .expect("get task A")
    .expect("task A present");
    tinyagents::harness::session_store::run_ledger::upsert_agent_team_task(
        &config.workspace_dir,
        tinyagents::harness::session_store::run_ledger::AgentTeamTaskUpsert {
            id: task_a.id.clone(),
            team_id: task_a.team_id.clone(),
            title: task_a.title.clone(),
            objective: task_a.objective.clone(),
            status: tinyagents::harness::session_store::run_ledger::AgentTeamTaskStatus::Done,
